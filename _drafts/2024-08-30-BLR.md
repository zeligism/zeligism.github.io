...
BLR is an elegant connection between optimization and Bayesian inference, which is slightly reminiscent of the one between ridge regression and the maximum a posteriori estimator given a Gaussian prior.
...
It is possible to derive momentum from BLR given an adjusted sub-problem involving an extra divergence term from the previous iterate.
Perhaps a derivation of momentum is possible through a smart choice of $$q_{\theta}$$, but this is still unknown as far as I'm concerned.
