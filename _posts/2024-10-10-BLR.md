...
The Bayesian Learning Rule (BLR) is an elegant connection between optimization and Bayesian inference that is reminiscent of the one between ridge regression and the maximum a posteriori estimator given a Gaussian prior, but in a much more general way.

This post involves some math, and the reader cannot get away from skipping it, unfortunately.
Sorry, but it's the truth.
Maybe you can take a look at Figure 1.
It won't really give you the accurate intuition you need, but hey, at least it doesn't have math.
...
The latter sections show derivations for different algorithms based on the BLR, and then we conclude with some discussion.
