...
The king of approximations when $$f$$ is differentiable is the [Taylor expansion](https://en.wikipedia.org/wiki/Taylor_series), which is found in every scientist's toolbox.
