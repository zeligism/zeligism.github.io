...
The main difference is that BLR has an entropy term, so now the BLR step would not exactly have the same exponential smoothing and the convenient cancellations in the updates.
...
Thanks for reaching this far and hope you enjoyed reading!
